...
function gatherDirectories(input) {
    var total = 0;
    var dirCount = 0;
    var currentLevelSize = 0;
    var levelHolder = [];
    var directoryCountPerLevel = [];
    var flag = false;
    for (var i = 0; i < input.length; i++) {
        var command = input[i].split(' ').filter(function (c) { return c; });
        console.log(command);
        if (command[0] == '$') {
            if (command[1] == "cd") {
                if (command[2] == "..") {
...
function gatherDirectoriesPartTwo(input) {
    var total = 0;
    var dirCount = 0;
    var currentLevelSize = 0;
    var levelHolder = [];
